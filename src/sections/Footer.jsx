      ...
      <div className="flex justify-between items-start flex-wrap gap-20 max-lg:flex-col">
        <div className="flex flex-col items-start">
          <a href="/">
            ...
            <p className="mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm">Get shoes ready for the new term at your nearest Nike store. Find your perfect size in the store. Get Rewards</p>
          </a>
        ...
        <div className="flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap ">
            {footerLinks.map(item => (
              <div key={item}>
                ...
                <ul>
                  {item.links.map(link =>(
                    <li className="mt-3 text-white-400 text-base font-montserrat leading-normal hover:text-slate-gray cursor-pointer" key={link.name}><a href="">{link.name}</a></li>
                  ))}
                </ul>
              </div>
            ))}
